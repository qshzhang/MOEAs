...
{
    public class DTLZ6_M : AbstractMOP
    {
        private static DTLZ6_M instance;
        private readonly int K = 10;

        private DTLZ6_M(int pd)
        {
        ...
        public static DTLZ6_M GetInstance(int pd)
        {
            if (instance == null)
            {
                instance = new DTLZ6_M(pd);
                instance.name = "DTLZ6_" + pd;
            }
            return instance;
        }
    }
